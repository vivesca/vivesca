...
- Output: `/Users/terry/epigenome/chromatin/Persona vs Procedure in Multi-Agent Systems - Research.md`
...
- **HK-specific Capco content:** Wealth management survey (74% HK affluents comfortable with AI), "Building Data Leadership in APAC" (Bertie Haskins, Dec 2025) with HKMA cross-sector AI guidelines reference. Full synthesis: `/Users/terry/epigenome/chromatin/Capco AI Methodology Research.md`
...
Full research in `~/epigenome/chromatin/Theo - International School Research.md` (VSA Deep Dive section).
