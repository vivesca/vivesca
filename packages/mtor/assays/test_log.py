...
from mtor.log import LogEntry, filter_stalls, read_log, summary_stats
...
def test_summary_stats():
    entries = [
        LogEntry("t1", "p", 100, 0, 2, "", "none", ""),
        LogEntry("t2", "p", 200, 1, 0, "", "built-nothing", ""),
        LogEntry("t3", "p", 150, 0, 1, "learned", "none", ""),
    ]
