...
```json
{
  "mcpServers": {
    "gmail": {
      ...
      "env": {
        "MCP_GMAIL_CREDENTIALS_PATH": "/Users/terry/epigenome/chromatin/scripts/credentials.json",
        "MCP_GMAIL_TOKEN_PATH": "/Users/terry/epigenome/chromatin/scripts/token.json"
      }
    }
  }
}
