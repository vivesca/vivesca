...
**Phase 2 trigger:** Topic queue at `~/epigenome/chromatin/Writing/Blog/Queue.md`. Each entry: topic, angle, optional seed notes. LaunchAgent runs daily (morning), picks the top unprocessed entry, generates, judges, publishes, and marks as done.
...
LaunchAgent (daily, 8am)
    ↓
Read ~/epigenome/chromatin/Writing/Blog/Queue.md — pick top entry
    ↓
...
- `~/epigenome/chromatin/terryli.hm.md` — garden index
