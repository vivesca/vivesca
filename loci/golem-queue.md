...
- [ ] `golem --provider volcano --max-turns 30 "Write tests for effectors/plan-exec. Effectors are scripts — load via exec or subprocess.run. NEVER import. Run uv run pytest. Fix failures. Commit." (retry)`
