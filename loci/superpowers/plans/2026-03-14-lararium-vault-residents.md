...
~/code/epigenome/chromatin/Lararium/              # Output folder — residents drop notes here
...
- Output dir: `~/code/epigenome/chromatin/Lararium/` (Obsidian vault)
...
- Output notes: `~/code/epigenome/chromatin/Lararium/<name>-YYYY-MM-DD.md`
...
- Vault notes in `~/code/epigenome/chromatin/Lararium/` are append-mode (multiple sessions per day stack)
```
...
| **Output** | `~/code/epigenome/chromatin/Lararium/` (Obsidian) |
