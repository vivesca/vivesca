...
**Files:**
- Create: `~/code/vivesca-terry/chromatin/Consulting/Policies/.gitkeep`
- Create: `~/code/vivesca-terry/chromatin/Consulting/Architectures/.gitkeep`
- Create: `~/code/vivesca-terry/chromatin/Consulting/Use Cases/.gitkeep`
- Create: `~/code/vivesca-terry/chromatin/Consulting/Experiments/.gitkeep`
- Create: `~/code/vivesca-terry/chromatin/Consulting/_sparks.md`
- Create: `~/code/vivesca-terry/chromatin/Consulting/_index.md`
- Create: `~/code/vivesca-terry/chromatin/Consulting/_weekly/.gitkeep`

- [ ] **Step 1: Create directory structure**

```bash
mkdir -p ~/code/vivesca-terry/chromatin/Consulting/{Policies,Architectures,"Use Cases",Experiments,_weekly}
```
...
```bash
ls -R ~/code/vivesca-terry/chromatin/Consulting -type f -o -type d | sort
```
...
Expected: sparks appended to `~/code/vivesca-terry/chromatin/Consulting/_sparks.md` under today's date header. Check with `tail -30 ~/code/vivesca-terry/chromatin/Consulting/_sparks.md`.
...
6. Writes weekly report to `~/code/vivesca-terry/chromatin/Consulting/_weekly/YYYY-WNN.md`
...
Check output: `cat ~/code/vivesca-terry/chromatin/Consulting/_sparks.md`
...
- Files appear in `~/code/vivesca-terry/chromatin/Consulting/` subdirectories
- `_index.md` updated
...
```bash
ls -R ~/code/vivesca-terry/chromatin/Consulting -name "*.md" -not -name "_*" | wc -l
```

Expected: >0 assets created.

```bash
head -20 ~/code/vivesca-terry/chromatin/Consulting/_index.md
```
...
```bash
grep -l "^---" ~/code/vivesca-terry/chromatin/Consulting/{Policies,Architectures,Use\ Cases,Experiments}/*.md | head -5
```
...
```bash
ls ~/code/vivesca-terry/chromatin/Capco/ ~/code/vivesca-terry/chromatin/HSBC/ 2>/dev/null
```
...
```bash
cd ~/code/vivesca-terry/chromatin && git add Consulting/ && git commit -m "feat: seed consulting IP library with generalized assets"
```
