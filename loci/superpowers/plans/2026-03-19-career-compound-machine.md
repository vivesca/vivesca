...
**Files:**
- Create: `~/notes/Consulting/Policies/.gitkeep`
- Create: `~/notes/Consulting/Architectures/.gitkeep`
- Create: `~/notes/Consulting/Use Cases/.gitkeep`
- Create: `~/notes/Consulting/Experiments/.gitkeep`
- Create: `~/notes/Consulting/_sparks.md`
- Create: `~/notes/Consulting/_index.md`
- Create: `~/notes/Consulting/_weekly/.gitkeep`

- [ ] **Step 1: Create directory structure**

```bash
mkdir -p ~/notes/Consulting/{Policies,Architectures,"Use Cases",Experiments,_weekly}
```
...
```bash
ls -R ~/notes/Consulting -type f -o -type d | sort
```
...
Expected: sparks appended to `~/notes/Consulting/_sparks.md` under today's date header. Check with `tail -30 ~/notes/Consulting/_sparks.md`.
...
Check output: `cat ~/notes/Consulting/_sparks.md`
...
- Files appear in `~/notes/Consulting/` subdirectories
- `_index.md` updated
...
```bash
ls -R ~/notes/Consulting -name "*.md" -not -name "_*" | wc -l
```

Expected: >0 assets created.

```bash
head -20 ~/notes/Consulting/_index.md
```
...
```bash
grep -l "^---" ~/notes/Consulting/{Policies,Architectures,Use\ Cases,Experiments}/*.md | head -5
```
...
```bash
ls ~/notes/Capco/ ~/notes/HSBC/ 2>/dev/null
```
...
```bash
cd ~/notes && git add Consulting/ && git commit -m "feat: seed consulting IP library with generalized assets"
```
