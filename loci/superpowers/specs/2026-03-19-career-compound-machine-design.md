...
All consulting IP lives under `~/code/vivesca-terry/chromatin/Consulting/`:

```
~/code/vivesca-terry/chromatin/Consulting/
...
**Inputs:**
- Lustro output from previous 24h (`~/code/vivesca-terry/chromatin/AI News Log.md`, last 24h entries)
...
- Thalamus landscape notes (`~/code/vivesca-terry/chromatin/Thalamus.md`) — lead agent synthesises directly, no dialexis dependency
...
**Worker output rules:**
- Each worker creates files directly in the appropriate `~/code/vivesca-terry/chromatin/Consulting/` subdirectory
...
1. **Create directory structure** — `~/code/vivesca-terry/chromatin/Consulting/` with subdirectories
