...
### Curated 10 (source: `~/code/vivesca-terry/chromatin/assets/every-covers/`)
...
3. Paste these CloudFront URLs one at a time (or drag-drop the files from `~/code/vivesca-terry/chromatin/assets/every-covers/`)
