...
- Athena's Aegis covers Jun–Dec 2024 only (80 daily notes). For older content (2022–2023), check Ideaverse/Metis-Codex/Bob-Fleeting in `~/epigenome/chromatin/Archive/`.
