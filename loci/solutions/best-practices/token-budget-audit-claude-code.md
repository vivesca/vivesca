...
The vault CLAUDE.md (`~/notes/CLAUDE.md`) loads as a system-reminder on every turn. It had accumulated procedural content, reference material, and duplicated context from the main CLAUDE.md.
