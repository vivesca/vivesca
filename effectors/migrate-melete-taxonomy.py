...
Usage:
    uv run /Users/terry/reticulum/bin/migrate-melete-taxonomy.py --dry-run   # preview only
    uv run /Users/terry/reticulum/bin/migrate-melete-taxonomy.py             # write changes
...
STATE_FILE = Path("/Users/terry/notes/.garp-fsrs-state.json")
...
#
# Source: /Users/terry/notes/GARP RAI Topic Taxonomy.md (Summary section)
