#!/usr/bin/env python3
"""Rebuild ~/code/vivesca/effectors/DueAddRecurring.shortcut from scratch.

Run when the shortcut needs to be updated or re-signed.
Usage: python3 ~/code/vivesca/effectors/build-due-shortcut.py
Then: open ~/code/vivesca/effectors/DueAddRecurring.shortcut → click "Add Shortcut"
"""
...
tmp_signed = os.path.expanduser("~/code/vivesca/effectors/DueAddRecurring.shortcut")
...
if result.returncode == 0:
    ...
    print(
        'Next: open ~/code/vivesca/effectors/DueAddRecurring.shortcut → click "Add Shortcut" in Shortcuts.app'
    )
