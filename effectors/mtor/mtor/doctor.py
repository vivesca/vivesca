...
from mtor import COACHING_PATH, TEMPORAL_HOST, TASK_QUEUE, VERSION, WORKER_HOST
    ...
    if all_ok:
        ...
        payload = {
            ...
            "next_actions": [
                ...
                _action(f"ssh {WORKER_HOST} 'sudo systemctl start temporal-worker'", "Start the worker"),
            ],
        }
