...
- **Questions:** `~/code/epigenome/chromatin/Capco/Capco Readiness Drill.md` — 40 numbered questions in 7 categories (A-G): tiering framework, regulatory landscape, AI/FS knowledge, consulting delivery, Capco culture, client questions (HSBC context), personal narrative
- **State:** `~/code/epigenome/chromatin/Capco/.capco-drill-state.json` — drill history and ratings
- **Reference:** Questions link to source material in `~/code/epigenome/chromatin/Capco/` — read if user asks "what's the answer?"
- **Verbal Narrative Bank:** `~/code/epigenome/chromatin/Capco/Verbal Narrative Bank.md` — practiced narratives for client and team introductions
- **Client First Meeting Cheat Sheet:** `~/code/epigenome/chromatin/Capco/Client First Meeting Cheat Sheet.md` — HSBC-specific first impression guide
- **90-Day Scorecard:** `~/code/epigenome/chromatin/Capco/90-Day Success Scorecard.md` — success metrics and gates for first 90 days

## Workflow

### 1. Load State

Read `~/code/epigenome/chromatin/Capco/.capco-drill-state.json`. If it doesn't exist, create it:
...
- **If question bank file missing:** Tell user to check `~/code/epigenome/chromatin/Capco/Capco Readiness Drill.md`
...
2. **Check First 30 Days checklist** — Read `~/code/epigenome/chromatin/Capco/Capco - First 30 Days.md`. Identify one unchecked item that's actionable today. Prioritise "Must do" over "Should do" over "Nice to have".
...
4. **Check drill weak spots** — Read `~/code/epigenome/chromatin/Capco/.capco-drill-state.json`. If there are "blank" or "shaky" questions, suggest revisiting one.
...
2. **Check vault first** — Search `~/code/epigenome/chromatin/Capco/` for existing prep notes (e.g., `Coffee Prep - Simon and Tobin.md`, `Bertie Haskins Profile.md`). Read any matches.
...
1. Read `~/code/epigenome/chromatin/Capco/.capco-drill-state.json` and `~/code/epigenome/chromatin/Capco/Capco Readiness Drill.md`.
