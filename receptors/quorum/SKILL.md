...
> Source: `~/code/quorum/`. Extended reference: `~/metabolon/receptors/quorum/REFERENCE.md`.
...
quorum --quick --quiet --domain banking -o ~/metabolon/loci/solutions/agent-tests/<name>.md "..."
```
...
Extended docs in `~/metabolon/receptors/quorum/REFERENCE.md`: prompting tips, model tendencies, flag compatibility matrix, follow-up workflow, cost & ROI, research foundations.
