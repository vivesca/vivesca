...
1. **Read context files**:
   - `/Users/terry/epigenome/chromatin/CLAUDE.md` — personal context
   - `/Users/terry/epigenome/chromatin/Core Story Bank.md` — prepared stories (if exists)
   - `/Users/terry/epigenome/chromatin/Interview Preparation.md` — general prep notes (if exists)
   - `/Users/terry/epigenome/chromatin/Job Hunting.md` — notes on this role/company
...
**Location:** `/Users/terry/epigenome/chromatin/Interview Prep - [Company].md`
