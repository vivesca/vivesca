...
1. **Read context files**:
   - `/Users/terry/code/epigenome/chromatin/CLAUDE.md` — personal context
   - `/Users/terry/code/epigenome/chromatin/Core Story Bank.md` — prepared stories (if exists)
   - `/Users/terry/code/epigenome/chromatin/Interview Preparation.md` — general prep notes (if exists)
   - `/Users/terry/code/epigenome/chromatin/Job Hunting.md` — notes on this role/company
...
**Location:** `/Users/terry/code/epigenome/chromatin/Interview Prep - [Company].md`
