...
- Default vault configured (Terry's vault: `/Users/terry/code/vivesca-terry/chromatin`)
...
```bash
mv "~/code/vivesca-terry/chromatin/Old Name.md" "~/code/vivesca-terry/chromatin/New Name.md"
```
