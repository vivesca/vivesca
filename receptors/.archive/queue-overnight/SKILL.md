...
2. **Read context:**
   - `/Users/terry/code/epigenome/chromatin/Job Hunting.md` — check for upcoming interviews
...
5. **Create overnight summary file:**
   - Path: `/Users/terry/code/epigenome/chromatin/Overnight Queue - YYYY-MM-DD.md`
...
4. Write summary to /Users/terry/code/epigenome/chromatin/Job Alert Review - YYYY-MM-DD.md
...
5. Write to /Users/terry/code/epigenome/chromatin/Pipeline Scan - YYYY-MM-DD.md
...
4. Write to /Users/terry/code/epigenome/chromatin/Interview Prep - [Company] - YYYY-MM-DD.md
```

## Output

**Overnight Queue file** at `/Users/terry/code/epigenome/chromatin/Overnight Queue - YYYY-MM-DD.md`:
