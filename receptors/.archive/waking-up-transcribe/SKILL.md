...
- **Output:** `~/code/epigenome/chromatin/Waking Up/[Pack]/[Title].md`
...
4. **Verify output** in `~/code/epigenome/chromatin/Waking Up/[Pack]/`
...
Markdown files in `~/code/epigenome/chromatin/Waking Up/[Pack]/[Title].md`
