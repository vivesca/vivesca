...
```bash
cat /Users/terry/code/epigenome/chromatin/WORKING.md 2>/dev/null || echo "No WORKING.md found"
```

### 2. Pending Items (always)

```bash
cat /Users/terry/code/epigenome/chromatin/Praxis.md 2>/dev/null | head -30
```
...
```bash
head -50 "/Users/terry/code/epigenome/chromatin/Active Pipeline.md"
```
