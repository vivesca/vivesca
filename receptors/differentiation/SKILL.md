...
2. Find the latest gym log: `~/code/epigenome/chromatin/Health/Gym Log - *.md`. Read it for working weights, notes for next session, and any form fixes flagged.
...
8. Write the completed log to `~/code/epigenome/chromatin/Health/Gym Log - YYYY-MM-DD.md` using this format:
