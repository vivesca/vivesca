...
- `[[Email Threads Tracker]]` (`~/code/vivesca-terry/chromatin/Email Threads Tracker.md`)
- `~/code/vivesca/engrams/prospective.md` — check for `WHEN: email triage` or `WHEN: interphase` entries
- Today's daily note (`~/code/vivesca-terry/chromatin/Daily/YYYY-MM-DD.md`)
...
- Read today's daily note (`~/code/vivesca-terry/chromatin/Daily/YYYY-MM-DD.md`) for cytokinesis session logs
...
- If anything shipped has consulting relevance (methodology, governance, AI pattern), append one line to `~/code/vivesca-terry/chromatin/Consulting/_sparks.md` under today's date: `- #[tag] — **[Title]**: [one-line consulting implication]`
