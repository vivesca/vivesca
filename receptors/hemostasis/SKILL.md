---
name: hemostasis
description: Emergency stabilization when something is broken — stop the bleeding, not fix it. "hemostasis", "stop the bleeding", "emergency stabilize", "system broken", "damage control".
user_invocable: true
model: sonnet
context: fork
---
