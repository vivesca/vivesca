---
name: morning-digest
description: Summarize overnight content intake — top endocytosis items, inbox signal, calendar context for today.
model: sonnet
...
1. Top RSS cargo: read ~/.cache/endocytosis/relevance.jsonl, show items scored >= 7 from last 24h with banking_angle
...
4. Receptor health: check ~/epigenome/chromatin/receptor-retirement.md for any new anoikis candidates
