...
1. Read recent daily notes: ~/code/vivesca-terry/chromatin/Daily/ (last 14 days)
...
Save log to ~/code/vivesca-terry/chromatin/Health/gym-log-YYYY-WNN.md if session data found.
