...
1. `~/code/vivesca-terry/chromatin/Praxis.md` — scan for financial items (IBKR, MPF, Bowtie, tax, mortgage, insurance)
2. `~/code/vivesca-terry/chromatin/Personal Finance Reference.md` — baseline figures
3. `~/code/vivesca-terry/chromatin/Finance/` and `~/code/vivesca-terry/chromatin/Financial/` directories — any recent notes
4. `~/.claude/projects/-Users-terry/memory/user_financial_constraints.md` — constraints
5. `~/code/vivesca-terry/chromatin/Pre-Capco Countdown - Apr 8 Deadline.md` — time-sensitive items
