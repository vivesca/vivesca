...
Draft a client-facing document. Read vault context first (~/code/epigenome/chromatin/Consulting/, Capco Transition). Professional tone for banking/financial services. No internal jargon. Evidence-based claims with regulatory citations. Structure: executive summary, body, recommendations. Save to ~/code/epigenome/chromatin/Consulting/.
