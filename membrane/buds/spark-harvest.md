...
1. Read this week's daily notes: ~/code/epigenome/chromatin/Daily/YYYY-MM-DD*.md
2. Read this week's vault additions: `cd ~/code/epigenome/chromatin && git log --oneline --since="7 days ago" --name-only`
3. Read recent session context: check ~/code/epigenome/chromatin/Reference/ modified in last 7 days
