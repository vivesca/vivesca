...
1. Vault first: `grep -r "[company name]" ~/notes/` — what do we already know?
2. Web research:
...
5. Save research to ~/notes/Archive/Job_Hunting_2026/Prep/[CompanyName].md
   OR ~/notes/Reference/consulting/clients/[CompanyName].md
