...
1. Vault first: `grep -r "[company name]" ~/code/vivesca-terry/chromatin/` — what do we already know?
2. Web research:
...
5. Save research to ~/code/vivesca-terry/chromatin/Archive/Job_Hunting_2026/Prep/[CompanyName].md
   OR ~/code/vivesca-terry/chromatin/Reference/consulting/clients/[CompanyName].md
