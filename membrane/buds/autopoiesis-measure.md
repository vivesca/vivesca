...
2. Count manual maintenance points:
   ...
   - Check ~/notes/Praxis.md for system/tool maintenance items

3. Compute the ratio: automated / (automated + manual)

4. Compare to previous measurements (check ~/notes/Reference/ for prior autopoiesis-measure results)
...
Save results to ~/notes/Reference/autopoiesis-measure-YYYY-MM-DD.md
