...
# /derepression — LLM Knowledge Mining

> *Derepression: removing a repressor from DNA, allowing a silenced gene to be expressed.*
...
| Truth-seeking | `[[truth-seeking-method]]` | 1 | derepression, rheotaxis, quorum, peira, rector | — |
...
| Learning | `[[learning-theory]]` | 1 | dokime, rector, derepression, [[parens]] (Reference), eow, daily, phronesis | — |
...
- **[[knowledge-structure]]** — designs skills (structure, naming). derepression is specifically about *extracting knowledge from model weights* into skills.
