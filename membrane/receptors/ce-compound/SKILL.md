...
```bash
/prompts:ce-compound                    # Document the most recent fix
/prompts:ce-compound [brief context]    # Provide additional context hint
```
...
**Always run full mode by default.** Proceed directly to Phase 1 unless the user explicitly requests compact-safe mode (e.g., `/prompts:ce-compound --compact` or "use compact mode").
...
- `/prompts:ce-compound-refresh plugin-versioning-requirements`
- `/prompts:ce-compound-refresh payments`
- `/prompts:ce-compound-refresh performance-issues`
- `/prompts:ce-compound-refresh critical-patterns`
...
<manual_override> Use /prompts:ce-compound [context] to document immediately without waiting for auto-detection. </manual_override> </auto_invoke>
...
- **Manual trigger**: User can invoke agents after /prompts:ce-compound completes for deeper review

## Related Commands

- `/research [topic]` - Deep investigation (searches docs/solutions/ for patterns)
- `/prompts:ce-plan` - Planning workflow (references documented solutions)
