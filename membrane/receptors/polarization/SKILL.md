...
3. External signals (endocytosis outputs, calendar proximity)
...
**Phase B — Scout:** Ask "what new directions does this reveal?" Check endocytosis/transduction for external signals. Check all six north stars. If any star has zero dispatched tasks, ask why.
...
3. Have you checked endocytosis/transduction for new signals?   → if not, check now
