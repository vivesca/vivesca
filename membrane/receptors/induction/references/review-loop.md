...
- Terms or entities flagged as undefined or unauthored → grep both chromatin and the paper's own appendices/frontmatter before filing the knockout. The Stream-4 "Design Authority" reference in v00.01 was correctly identifiable as Project-100-Days substance only after grepping G1 Stream-4 retraction context, not from semantic guessing.
