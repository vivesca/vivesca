...
1. **Read context files**:
   - `~/epigenome/chromatin/CLAUDE.md` — personal context
   - `~/epigenome/chromatin/Core Story Bank.md` — prepared stories (if exists)
   - `~/epigenome/chromatin/Interview Preparation.md` — general prep notes (if exists)
   - `~/epigenome/chromatin/Job Hunting.md` — notes on this role/company
...
**Location:** `~/epigenome/chromatin/Interview Prep - [Company].md`
