...
- **Output:** `~/epigenome/chromatin/Waking Up/[Pack]/[Title].md`
...
4. **Verify output** in `~/epigenome/chromatin/Waking Up/[Pack]/`
...
Markdown files in `~/epigenome/chromatin/Waking Up/[Pack]/[Title].md`
