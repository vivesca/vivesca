...
```
~/epigenome/chromatin/CLAUDE.md          — personal background, situation
~/epigenome/chromatin/Active Pipeline.md — live pipeline (offers, interviews, leads)
~/epigenome/chromatin/Job Hunting.md     — comp, market signals, differentiators, wins/objections
```
