...
2. **Read context:**
   - `~/epigenome/chromatin/Job Hunting.md` — check for upcoming interviews
...
5. **Create overnight summary file:**
   - Path: `~/epigenome/chromatin/Overnight Queue - YYYY-MM-DD.md`
...
4. Write summary to ~/epigenome/chromatin/Job Alert Review - YYYY-MM-DD.md
...
5. Write to ~/epigenome/chromatin/Pipeline Scan - YYYY-MM-DD.md
...
4. Write to ~/epigenome/chromatin/Interview Prep - [Company] - YYYY-MM-DD.md
```

## Output

**Overnight Queue file** at `~/epigenome/chromatin/Overnight Queue - YYYY-MM-DD.md`:
