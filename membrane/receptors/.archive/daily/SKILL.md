...
4. **Check for existing note** at `~/epigenome/chromatin/YYYY-MM-DD.md`
...
7. **Save to vault** at `~/epigenome/chromatin/YYYY-MM-DD.md`
...
**Location:** `~/epigenome/chromatin/YYYY-MM-DD.md`
