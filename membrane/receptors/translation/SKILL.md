...
**Method:** For each major plan section, dispatch a parallel translocon call to research best practices:

```bash
# Parallel research per section
translocon --build ~/germline "Research best practices for: [section topic]. Find: industry patterns, performance considerations, common pitfalls, concrete code examples."
```
...
- Web search for recent (2024-2026) patterns via `translocon --mcp "search [topic] best practices"`
