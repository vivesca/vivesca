...
**Files:**
- Create: `~/epigenome/chromatin/Consulting/Policies/.gitkeep`
- Create: `~/epigenome/chromatin/Consulting/Architectures/.gitkeep`
- Create: `~/epigenome/chromatin/Consulting/Use Cases/.gitkeep`
- Create: `~/epigenome/chromatin/Consulting/Experiments/.gitkeep`
- Create: `~/epigenome/chromatin/Consulting/_sparks.md`
- Create: `~/epigenome/chromatin/Consulting/_index.md`
- Create: `~/epigenome/chromatin/Consulting/_weekly/.gitkeep`

- [ ] **Step 1: Create directory structure**

```bash
mkdir -p ~/epigenome/chromatin/Consulting/{Policies,Architectures,"Use Cases",Experiments,_weekly}
```
...
```bash
ls -R ~/epigenome/chromatin/Consulting -type f -o -type d | sort
```
...
Expected: sparks appended to `~/epigenome/chromatin/Consulting/_sparks.md` under today's date header. Check with `tail -30 ~/epigenome/chromatin/Consulting/_sparks.md`.
...
6. Writes weekly report to `~/epigenome/chromatin/Consulting/_weekly/YYYY-WNN.md`
...
Check output: `cat ~/epigenome/chromatin/Consulting/_sparks.md`
...
- Files appear in `~/epigenome/chromatin/Consulting/` subdirectories
- `_index.md` updated
...
```bash
ls -R ~/epigenome/chromatin/Consulting -name "*.md" -not -name "_*" | wc -l
```

Expected: >0 assets created.

```bash
head -20 ~/epigenome/chromatin/Consulting/_index.md
```
...
```bash
grep -l "^---" ~/epigenome/chromatin/Consulting/{Policies,Architectures,Use\ Cases,Experiments}/*.md | head -5
```
...
```bash
ls ~/epigenome/chromatin/Capco/ ~/epigenome/chromatin/HSBC/ 2>/dev/null
```
...
```bash
cd ~/epigenome/chromatin && git add Consulting/ && git commit -m "feat: seed consulting IP library with generalized assets"
```
