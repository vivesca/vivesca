...
~/epigenome/chromatin/Lararium/              # Output folder — residents drop notes here
...
- Output dir: `~/epigenome/chromatin/Lararium/` (Obsidian vault)
...
| **Output** | `~/epigenome/chromatin/Lararium/` (Obsidian) |
