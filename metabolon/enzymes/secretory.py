...
# -- Interphase: daily note close -----------------------------------------
# Originally from interphase.py — daily note close write for evening routine.
# The gather step is covered by pinocytosis_interphase.
...
_INTERPHASE_DAILY_DIR = Path.home() / "epigenome" / "chromatin" / "Daily"
...
def interphase_close_daily_note(
    ...
    note_path = _INTERPHASE_DAILY_DIR / f"{d.isoformat()}.md"
