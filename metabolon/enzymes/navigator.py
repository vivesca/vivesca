...
def navigator(
    ...
    # ── click ────────────────────────────────────────────────────────────
        ...
        if not ok:
            return NavigatorResult(
                success=False, data={"css_selector": css_selector},
    ...
    # ── fill ─────────────────────────────────────────────────────────────
        ...
        if not ok:
            return NavigatorResult(
                success=False, data={"css_selector": css_selector, "value": value},
    ...
    # ── resize ───────────────────────────────────────────────────────────
        ...
        if not ok:
            return NavigatorResult(
                success=False, data={"width": width, "height": height},
