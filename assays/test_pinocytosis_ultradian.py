...
def test_pinocytosis_ultradian_intake_raises_not_implemented():
...
def test_pinocytosis_ultradian_intake_as_json_parameter():
...
def test_pinocytosis_ultradian_main_calls_intake_with_default_args(monkeypatch, capsys):
...
def test_pinocytosis_ultradian_main_with_json_flag(monkeypatch, capsys):
...
def test_pinocytosis_ultradian_main_without_json_flag(monkeypatch, capsys):
