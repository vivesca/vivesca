...
def test_default_values():
    ...
    bud.parser.add_argument(
        "-p", "--project-dir", default=str(Path.home() / "germline"), help="Project directory"
    )
    bud.parser.add_argument(
        "--auto", default="high", choices=["low", "medium", "high"], help="Autonomy level"
    )
