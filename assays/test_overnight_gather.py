...
def test_status_icon_completed_no_flags():
    ...
    task = overnight.TaskSummary(
        name="test", title=None, status="completed",
        has_errors=False, flagged=False, flagged_lines=[],
        stdout="done", stderr=""
    )
...
def test_status_icon_flagged_returns_warn():
    ...
    task = overnight.TaskSummary(
        name="test", title=None, status="completed",
        has_errors=False, flagged=True, flagged_lines=[],
        stdout="done", stderr=""
    )
    ...
    task2 = overnight.TaskSummary(
        name="test", title=None, status="completed",
        has_errors=True, flagged=False, flagged_lines=[],
        stdout="done", stderr="error"
    )
...
def test_render_task_label_with_title():
    ...
    task = overnight.TaskSummary(
        name="test-task", title="Test Task", status="completed",
        has_errors=False, flagged=False, flagged_lines=[],
        stdout="", stderr=""
    )
...
def test_render_task_label_no_title():
    ...
    task = overnight.TaskSummary(
        name="test-task", title=None, status="completed",
        has_errors=False, flagged=False, flagged_lines=[],
        stdout="", stderr=""
    )
    result = overnight.render_task_label(task)
