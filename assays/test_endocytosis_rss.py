...
from metabolon.tools.endocytosis_rss import (
    _compute_stats,
    _get_top_items,
    _read_jsonl,
)
...
class TestComputeStats:
    def test_no_affinity_log_returns_insufficient(self, tmp_path):
        with (
            patch("metabolon.tools.endocytosis_rss._AFFINITY_LOG", tmp_path / "missing.jsonl"),
            patch("metabolon.tools.endocytosis_rss._ENGAGEMENT_LOG", tmp_path / "eng.jsonl"),
        ):
    ...
    def test_basic_stats(self, tmp_path):
        ...
        with (
            patch("metabolon.tools.endocytosis_rss._AFFINITY_LOG", aff),
            patch("metabolon.tools.endocytosis_rss._ENGAGEMENT_LOG", eng),
        ):
            result = _compute_stats()
...
class TestGetTopItems:
    def test_returns_empty_when_no_data(self, tmp_path):
        with patch("metabolon.tools.endocytosis_rss._AFFINITY_LOG", tmp_path / "missing.jsonl"):
...
class TestToolSchemas:
    def test_stats_tool_returns_secretion(self, tmp_path):
        from metabolon.tools.endocytosis_rss import endocytosis_rss_stats
    ...
    def test_top_tool_returns_secretion(self, tmp_path):
        from metabolon.tools.endocytosis_rss import endocytosis_rss_top
    ...
    def test_top_tool_empty_returns_empty_result(self, tmp_path):
        ...
        with patch("metabolon.tools.endocytosis_rss._AFFINITY_LOG", tmp_path / "none.jsonl"):
    ...
    def test_stats_insufficient_data(self, tmp_path):
        ...
        with (
            patch("metabolon.tools.endocytosis_rss._AFFINITY_LOG", tmp_path / "none.jsonl"),
            patch("metabolon.tools.endocytosis_rss._ENGAGEMENT_LOG", tmp_path / "none2.jsonl"),
        ):
            result = endocytosis_rss_stats()
