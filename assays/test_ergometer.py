"""Tests for metabolon/enzymes/ergometer.py"""
...
class TestErgometerSlowest:
    ...
    def test_slowest_with_custom_hours(self, mock_slowest):
        ...
        result = ergometer("slowest", hours=4)
...
class TestErgometerEta:
    ...
    def test_eta_zero_tasks(self, mock_eta):
        ...
        result = ergometer("eta", remaining_tasks=0)
    ...
    def test_eta_large_task_count(self, mock_eta):
        ...
        result = ergometer("eta", remaining_tasks=500)
...
class TestErgometerUnknownAction:
    ...
    def test_unknown_action_case_preserved(self):
        ...
        result = ergometer("UNKNOWN")
        assert "Unknown action: unknown" in result  # action is lowercased


class TestErgometerActionCaseHandling:
