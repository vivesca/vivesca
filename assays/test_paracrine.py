...
def test_axes_has_correct_keys():
    ...
    for keywords in paracrine.AXES.values():
...
def test_cluster_by_axis_no_matches():
    ...
    memories = [{"full_text": "this has no keywords from any axis", "file": "feedback_test.md"}]
...
def test_detect_tensions_autonomy_tension():
    ...
    do_it_mem = {"file": "do_it.md", "full_text": "just do it".lower()}
    hold_mem = {"file": "hold.md", "full_text": "hold and gate".lower()}
...
def test_detect_tensions_autonomy_one_side():
    ...
    only_do_it = [{"file": "do_it.md", "full_text": "just do it".lower()}]
...
def test_detect_tensions_speed_vs_quality_tension():
    ...
    fast_mem = {"file": "fast.md", "full_text": "do it quickly immediately".lower()}
    careful_mem = {"file": "careful.md", "full_text": "verify and check thoroughly".lower()}
...
def test_detect_tensions_capture_vs_flow_tension():
    ...
    capture_mem = {"file": "capture.md", "full_text": "capture and save everything".lower()}
    flow_mem = {"file": "flow.md", "full_text": "keep the energy flowing don't cut".lower()}
