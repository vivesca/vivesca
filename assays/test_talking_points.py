...
def test_talking_point_card_to_markdown():
    from metabolon.organelles.talking_points import TalkingPoint, TalkingPointCard
    ...
    card = TalkingPointCard(
        ...
        points=[
            TalkingPoint(
                thesis="Point 1", evidence="ev1", positioning="pos1", source_asset="a.md"
            ),
        ],
...
def test_score_relevance_client_match():
    ...
    asset = {
        "content_preview": "HSBC AI governance framework",
        "title": "Policy",
        "domain": "banking",
    }
