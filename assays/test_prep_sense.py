def test_restore_goals(tmp_path):
    ...
    (goals_dir / "capco.yaml").write_text(
        ...
        "  - name: delivery\n"
        "materials:\n"
        "  - path: ~/code/vivesca-terry/chromatin/HSBC Flashcard Deck - 2026-03-19.md\n"
        "    type: flashcards\n"
        "    categories: [D1, D2, D3, D4, D5, D6, D7]\n"
        "  - path: ~/code/vivesca-terry/chromatin/HSBC Delivery Readiness — Drill Map.md\n"
        "    type: drills\n"
    )
...
def test_synthesize_signal_summary(tmp_path):
    ...
    goal = {
        ...
        "materials": [
            {"path": "~/code/vivesca-terry/chromatin/deck.md", "type": "flashcards", "categories": ["D1", "D2", "D3"]},
        ],
    }
...
def test_proprioception_sense_with_goal(tmp_path, monkeypatch):
    ...
    (goals_dir / "capco.yaml").write_text(
        ...
        "  - name: delivery\n"
        "materials:\n"
        "  - path: ~/code/vivesca-terry/chromatin/deck.md\n"
        "    type: flashcards\n"
        "    categories: [D1, D2]\n"
    )
