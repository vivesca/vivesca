...
class TestSpending:
    ...
    @patch("metabolon.enzymes.catabolism.assess_missing_statements")
    @patch("metabolon.enzymes.catabolism.flag_overdue_payments")
    @patch("metabolon.enzymes.catabolism.metabolize_statements")
...
class TestConfirm:
    ...
    @patch("metabolon.enzymes.catabolism.dequeue_payment")
