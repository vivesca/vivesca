...
class TestPromptTemplates:
    ...
    def test_debate_prompt(self):
        from metabolon.organelles.quorum import Contribution, _debate_prompt
    ...
    def test_judge_prompt(self):
        from metabolon.organelles.quorum import Contribution, _judge_prompt
